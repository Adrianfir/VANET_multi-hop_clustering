...
if __name__ == "__main__":
    ...
    for i in range(configs.iter):
        ...
        a.save_map_img(1, '/Users/pouyafirouzmakan/Desktop/VANET_multi-hop_clustering/saved_imgs/Graph' + str(i))
    end_time = time.time()
    util.make_slideshow('/Users/pouyafirouzmakan/Desktop/VANET_multi-hop_clustering/saved_imgs/',
                        '/Users/pouyafirouzmakan/Desktop/VANET_multi-hop_clustering/saved_imgs/', configs.fps)
    # a.show_graph(configs)
    a.print_table()
