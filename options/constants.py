...
class Inputs:
    def __init__(self):
        ...
        fps = 5
        weights_s = np.array([0.2, 0.0, 0.8])       # direction's angle, speed, distance for single-hop
        weights_m = np.array([0.2, 0.0, 0.8])       # direction's angle, speed, distance for multi-hop
