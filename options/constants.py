...
class Inputs:
    def __init__(self):
        ...
        trace_path = str(pathlib.Path(__file__).parent.parent.parent.absolute().
                         joinpath('traffic_data', 'multi-hop_data_Richmondhill', 'sumoTrace.xml'))
        sumo_edge_path = str(pathlib.Path(__file__).parent.parent.parent.absolute().
                             joinpath('traffic_data', 'multi-hop_data_Richmondhill', 'osm.net.xml'))
        sumo_node_path = str(pathlib.Path(__file__).parent.parent.parent.absolute().
                             joinpath('traffic_data', 'multi-hop_data_Richmondhill', 'osm_bbox.osm.xml'))
